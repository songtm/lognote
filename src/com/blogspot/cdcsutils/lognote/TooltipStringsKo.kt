    ...
    companion object {
        ...
        init {
            val stringList = listOf(
                ...
                , "필터를 적용하는 로그 위치"
                , "순서 : A|B|C|D...\n값 : 이름,로그 위치(샘플 텍스트 테이블 참조),폭(-1 : 나머지)\n설정된 로그 위치만 표시"
                , "선택된 로그를 보여줍니다. 긴 로그는 줄바꿈으로 전체 로그가 보여지며, 텍스트의 일부분을 선택 할 수 있습니다."
                , "선택된 패키지의 현재 PID 를 가져와서 PID 필터에 설정합니다"
                , "비정상 로그(스택 트레이스, 빈 줄 등의 연속 라인) 표시/숨김"
//            , ""
            )
